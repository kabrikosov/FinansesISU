        ...
        <div className="authorization_overlay display-none">
            <div className="authorization">
                ...
                <div className="authorization__input">
                    <input type="number" name="monthlyIncome" placeholder="Monthly income" value={state.monthlyIncome}
                           onChange={e => setState({
                               login: state.login,
                               pass: state.pass,
                ...
                <div className="authorization__input">
                    <input type="number" name="cashAvailable" placeholder="Cash available" value={state.cashAvailable}
                           onChange={e => setState({
                               login: state.login,
                               pass: state.pass,
                               monthlyIncome: state.monthlyIncome,
